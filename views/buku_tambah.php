...
if ($_POST) {
    $loker_buku = mysqli_real_escape_string($koneksi, $_POST['loker_buku']);
    $rak = mysqli_real_escape_string($koneksi, $_POST['no_rak']);
    $laci = mysqli_real_escape_string($koneksi, $_POST['no_laci']);
    $boks = mysqli_real_escape_string($koneksi, $_POST['no_boks']);
    ...
    $sql = "INSERT INTO buku VALUES (NULL, '$loker_buku', '$rak', '$laci', '$boks', '$judul_buku', '$pengarang', '$tahun_terbit', '$penerima', '$penerbit', '$status', '$ket')";
